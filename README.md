...
zone; it switches once per edge entry and re-arms after leaving the zone. Pointer
positions are centered on every remote activation and after an accepted return to
local control, preventing the cursor from remaining at a switching edge.
